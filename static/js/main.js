...
$('#newLayer').on("click",function(event) {
    ...
    // 1 es NASA POWER, 2 es SMN, 3 es IGN
...
//1 precipitacion
var opt_1 = new Array ("", "NASA POWER","SMN" );
//2 temp med, temp max temp min
var opt_2 = new Array ("", "NASA POWER", "SMN", "CHIRPS", "ERA5");
//3 radiacion
var opt_3 = new Array ("", "NASA POWER", "SMN","ERA5");
//4 solo mensual
